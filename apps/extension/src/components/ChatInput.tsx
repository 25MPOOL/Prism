...
export const ChatInput = () => {
  const { sendMessage, isLoading } = useChat({ autoConnect: false });
        ...
        <div className="flex flex-col">
          ...
          <div className="flex items-center justify-between px-2 pb-2">
            ...
            <button
              ...
              className="inline-grid h-8 w-8 flex-shrink-0 place-content-center rounded-md border border-transparent px-1.5 duration-75 hover:bg-[#656c7626] disabled:opacity-60"
            >
              {isLoading ? (
